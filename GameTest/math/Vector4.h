...
public:
	...
	static void Rotate(Vector4&, Degrees&, Axis, RotationDirection);
	// 
	void Rotate(Radians&, Axis, RotationDirection);
	static void Rotate(Vector4&, Radians&, Axis, RotationDirection);
	...
	// Cout Overload
	friend std::ostream &operator<<(std::ostream &stream, Vector4& ob);

...
float Vector4::NormalizeSelf()
{
	float Square_Length = x * x + y * y + z * z + w * w;
...
{
	float Inverse_Squareroot = MathCore::InverseSqrt(x * x + y * y + z * z + w * w);
	return Vector4(
		x * Inverse_Squareroot,
		y * Inverse_Squareroot,
		z * Inverse_Squareroot,
		w * Inverse_Squareroot
	);
}
...
// Rotate
void Vector4::Rotate(Degrees& Deg, Axis Axis_Selected, RotationDirection Rot)
{
	Rotate(Radians(Deg.GetRadians()), Axis_Selected, Rot);
}
void Vector4::Rotate(Vector4& V, Degrees& Deg, Axis Axis_Selected, RotationDirection Rot)
{
	V.Rotate(Deg, Axis_Selected, Rot);
}
// 
void Vector4::Rotate(Radians& Rad, Axis Axis_Selected, RotationDirection Rot)
{
	// Radians
...
void Vector4::Rotate(Vector4& V, Radians& Rad, Axis Axis_Selected, RotationDirection Rot)
{
...
Vector4 Vector4::Snap(Vector4 v)
{
	v.Snap();
	return v;
}
...
std::ostream &operator<<(std::ostream &stream, Vector4& ob)
{
